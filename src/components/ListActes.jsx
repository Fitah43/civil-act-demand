...
function ListActes({ status, onClick }) {
  ...
  const fetchActes = async () => {
    try {
      ...
      if (!data) SetEmpty("Accune demande en ce moment !");
      else {
        setActes(data);
        SetEmpty("");
      }
  ...
  if (status) {
    fetchActes();
    console.log("normalement une " + status);
    onClick(false);
  }
  ...
  const handleDelete = async (numAct) => {
    try {
      ...
      await axios.delete("http://localhost:3005/api/act/delete", {
        data: { numAct },
      });
      // : acteToDelete
      ...
      MySwal.fire(
        "Supprimé !",
        "L’acte a été supprimé avec succès.",
        "success"
      );
      fetchActes();
    } catch (error) {
      ...
      >
        ...
        <DialogContent>
          <TextField
            label="Numéro d'Acte"
            value={numActe}
            onChange={(e) => setNumActe(e.target.value)}
            fullWidth
            margin="normal"
          />
          <TextField
          ...
          <TextField
            ...
            value={nameCommune}
            onChange={(e) => setNameCommune(e.target.value)}
            fullWidth
            margin="normal"
          />
          <TextField
            ...
            value={nameCit}
            onChange={(e) => setNameCit(e.target.value)}
            fullWidth
            margin="normal"
          />
          <TextField
            ...
            value={firstNameCit}
            onChange={(e) => setFirstNameCit(e.target.value)}
            fullWidth
            margin="normal"
          />
          <TextField
          ...
          <TextField
            ...
            value={placeOB}
            onChange={(e) => setPlaceOB(e.target.value)}
            fullWidth
            margin="normal"
          />
          <TextField
            ...
            type="date"
            value={delivrance}
            onChange={(e) => setDelivrance(e.target.value)}
            fullWidth
            margin="normal"
          />
          <TextField
          ...
          <TextField
            ...
            margin="normal"
          />
          <img src={`data:image/png;base64,${files}`} alt="file actuel" />
          <input
            type="file"
            name="files"
